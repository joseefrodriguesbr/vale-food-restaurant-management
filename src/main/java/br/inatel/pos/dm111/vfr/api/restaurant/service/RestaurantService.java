...
public class RestaurantService
{
	...
	public RestaurantService(RestaurantRepository repository, UserRepository userRepository, AppPublisher restaurantPublisher)
	{
	...
	public RestaurantResponse createRestaurant(RestaurantRequest request) throws ApiException
	{
		...
		if (!published)
		{
			...
			log.error("User created was not published. Needs to be re published later on... User Id: {}", restaurant.id());
		}
